...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var menuItem:FlxSprite = new FlxSprite(0, FlxG.height * 2.2);
			menuItem.frames = tex;
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, gameVer +  (Main.watermarks ? " FNF | " + kadeEngineVer + " KE | DING MOD 1.0 PRERELEASE" : ""), 12);
